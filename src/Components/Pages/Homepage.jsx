import { Heading, Box, Flex, UnorderedList, ListItem, Image, Input, InputGroup, InputRightElement, Button, Avatar, HStack } from '@chakra-ui/react';
        ...
        <Box>
            <UnorderedList listStyleType='none'>
                <Flex align='center' justify='space-between' p='1em'>
                    ...
                    <HStack>
                        <ListItem>
                            <Button bgColor='#1F50FF' color='white' fontFamily='Hyundai Sans Head Office' _hover={{ bgColor: '#6F75F7' }} leftIcon={<MdAdd />}>Create</Button>
                        </ListItem>
                        <ListItem>
